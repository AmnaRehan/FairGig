...
export const authAPI = axios.create({ baseURL: 'https://fairgig-auth-ssmf.onrender.com' });
// export const earningsAPI = axios.create({ baseURL: 'http://localhost:8001' });
export const earningsAPI = axios.create({ baseURL: 'https://fairgig-earnings-o88z.onrender.com' });
...
export const certificateAPI = axios.create({ baseURL: 'https://fairgig-certificate-1pnk.onrender.com' });
